...
def abrirJogoFrutas():
	...
	#Sortear palavra
	frutas = ["abacaxi", "banana", "melao", "morango", "uva", "lichia", "ameixa", "açai", "amora", "goiaba", "cacau", "coco", "caju", "coquinho", "guarana", "jurubeba", "maracuja", "limao", "pitanga", "seriguela", "pequi", "acerola", "pera"]
...
def abrirJogoObjetos():
	...
	#Sortear palavra
	objetos = ["abajur", "agulha", "cadeado", "hidrante", "almofada", "campainha", "ampulheta", "candelabro", "guilhotina", "bicicleta", "bambole", "cinzero", "chinelo", "descascador", "esparadrapo", "frigideira", "furadeira", "grampeador"]
